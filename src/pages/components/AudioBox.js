export default function AudioBox(){
    return (
        <div className="flex flex-col gap-12 items-center justify-center w-[76%] h-full">
            <div className="w-full text-white text-[40px] font-[400] font-[Inria Sans] ">
                Set the Rhythm
            </div>
            <div className=" h-[45%] gap-8 w-full flex flex-row justify-center items-center">
                <div style={{width: '100%', height: '100%', background: '#3A141E', borderRadius: 20}} />
                <div style={{width: '100%', height: '100%', background: '#3A141E', borderRadius: 20}} />
                <div style={{width: '100%', height: '100%', background: '#3A141E', borderRadius: 20}} />
                <div style={{width: '100%', height: '100%', background: '#3A141E', borderRadius: 20}} />
            </div>
